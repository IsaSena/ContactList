...
namespace Contact
{
    public partial class Form1 : Form
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e) //metodo criado ao ser clicado na imagem 2x
        {
            MessageBox.Show("ContactList 1.0.\nWritten by Isabela", "About"); //depois da virgula o parametro para o titulo da caixa
        }
